    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 p-8">
                ...
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Nombre de la dirección</h3>
                    <p class="text-lg font-semibold text-gray-900">{{ $shippingAddress->number }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Descripción</h3>
                    <p class="text-lg font-semibold text-gray-900">{{ $shippingAddress->street }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Vecindario</h3>
                    <p class="text-lg font-semibold text-gray-900">{{ $shippingAddress->neighborhood }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Dirección de envío</h3>
                    <p class ="text-lg font-semibold text-gray-900">{{ $shippingAddress->city }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">subTotal</h3>
                    <p class="text-lg font-semibold text-gray-900">{{ $shippingAddress->reference_location }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Total</h3>
                    <p class="text-lg font-semibold text-gray-900">{{ $shippingAddress->address_status }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Descuento</h3>
                    <p class="text-lg font-semibold text-gray-900">{{ $shippingAddress->customer }}</p>
                </div>

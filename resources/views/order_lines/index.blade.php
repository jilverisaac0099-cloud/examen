                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-600 dark:text-gray-400 max-w-xs truncate">
                                            {{ $order_line->order ?? 'Sin pedido' }}
                                         </div>

                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-600 dark:text-gray-400 max-w-xs truncate">
                                            {{ $order_line->article ?? 'Sin articulo' }}
                                         </div>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end items-center space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <form action="{{ route('order_lines.destroy', $order) }}" method="POST" class="inline" id="form-delete-{{ $order_line->id }}">
                                                @csrf
                                                @method('DELETE')

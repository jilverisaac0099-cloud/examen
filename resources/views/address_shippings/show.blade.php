                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($shipping_addresses as $shiping_address)
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    <td class="px-6 py-4">
                                        <span class="text-sm font-mono text-gray-400">{{ $factory_article->id }}</span>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end items-center space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <a href="{{ route('s.show', $shiping_address) }}" class="text-gray-400 hover:text-indigo-600 transition-colors" title="Ver">
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 text-lg font-medium">No hay direccion registrada</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse

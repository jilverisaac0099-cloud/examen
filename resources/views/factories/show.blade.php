    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-8">
                ...
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Número de identificación</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $factory->identification_number }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Teléfono</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $factory->telephone }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Correo electrónico</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $factory->email }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Dirección</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $factory->address }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Estado del proveedor</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $factory->supplier_status }}</p>
                </div>

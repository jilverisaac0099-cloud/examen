        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $article->internal_code }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Descripción detallada</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $article->detailed_description }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Precio</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $article->price }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Costo</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $article->cost }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Estado disponible</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $article->available_status }}</p>
                </div>
                <div class="mb-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Fecha de entrada</h3>
                    <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $article->entry_date }}</p>
                </div>
